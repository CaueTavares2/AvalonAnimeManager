      ...
      <div className="max-w-md w-full bg-[var(--color-card)] p-12 rounded-3xl border border-[var(--color-border)] shadow-2xl space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-700">
        ...
        {window !== window.parent && (
          <div className="bg-yellow-500/10 border border-yellow-500/50 text-yellow-500 p-4 rounded-xl text-xs font-bold text-center">
            ...
            O login pode falhar devido ao bloqueio de cookies no modo de pré-visualização. 
            <br/><br/>
            Para funcionar, abra este site em uma <span className="text-white">NOVA GUIA</span> usando o botão no canto superior direito.
          </div>
        )}
